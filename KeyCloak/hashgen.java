...
Examples:
1) java -cp . hashgen hashcat bYjGueAuZgUG2URhIui3zg== 20000 512 PBKDF2WithHmacSHA1
Hash: Ir7uS0o9ouav1VCly0801VyioaQ/1sjwViHFmgD4kakDzzI39fRSifJutjbkd33U914v9QMVy+pF5k+xp+86cQ==
2) java -cp . hashgen hashcat bYjGueAuZgUG2URhIui3zg== 100000 512 PBKDF2WithHmacSHA256
Hash: 1IqX6hPxxAGwf/aZUUTKpZzf7MLYTLWNFTtGwTfwQA9mU04tA8M4Y1d2yAwF6MFWOiYZpEnIX//RdsY81UGnQw==
3) java -cp . hashgen hashcat bYjGueAuZgUG2URhIui3zg== 27500 512 PBKDF2WithHmacSHA512
...
public class hashgen {
 public static void main(String[] args) throws Exception {
  try{
   String p = args[0]; System.out.print("Password: " + p);
   String s = args[1]; System.out.print(" Salt: " + s);
   int i = Integer.parseInt(args[2]); System.out.print(" Iterations: " + i);
   int k = Integer.parseInt(args[3]); System.out.print(" Key size: " + k);
   String a = args[4]; System.out.println(" PBKDF2_Algorithm: " + a);
   PBEKeySpec spec = new PBEKeySpec(p.toCharArray(), Base64.getDecoder().decode(s), i, k);
